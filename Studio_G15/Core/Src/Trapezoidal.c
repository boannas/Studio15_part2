...
static float Distance_Velo_Max;
static float Time_Velo_const;
static float time_ref1;
static float time_ref2;
static float Distance;
static float Time_acc;
static float Time_dec;
static float temp_pos_acc;
static float temp_pos_const;
static float temp_velo_acc;
